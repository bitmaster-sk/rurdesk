...
export abstract class UiMotion {
     ...
     */
    public static pulseElement(el: HTMLElement, options: { inset?: boolean } = {}): void {
        ...
        const keyframes = options.inset
            ...
            : [
                  {
                      boxShadow:
                          '0 0 0 0 color-mix(in srgb, var(--ui-color-primary) 55%, transparent)'
                  },
                  {
                      boxShadow:
                          '0 0 0 7px color-mix(in srgb, var(--ui-color-primary) 0%, transparent)'
                  }
              ];
