...
export abstract class GanttOrderUtil {
    /**
     ...
     */
    public static applyPendingOrder<T extends { idIssuePublic?: number }>(
        tasks: T[],
        order: number[] | null
    ): T[] {
     ...
     */
    public static topologicalSort<T extends Issue>(issues: T[], relations: GanttRelation[]): T[] {
     ...
     */
    public static orderScheduled<T extends Issue>(issues: T[], relations: GanttRelation[]): T[] {
