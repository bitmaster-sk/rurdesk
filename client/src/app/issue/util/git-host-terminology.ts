 ...
 */
export abstract class GitHostTerminology {
    public static termKey(hostType: HostType | null | undefined): string {
        switch (hostType) {
     ...
     * Same host mapping as termKey(); consumers translate independently.
     */
    public static linkTitleKey(hostType: HostType | null | undefined): string {
        switch (hostType) {
            case HostType.GitHub:
